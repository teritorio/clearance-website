...
Se realiza una corrección en OpenStreetMap. En la siguiente actualización, si los objetos afectados se vuelven validos, los cambios acumulados se **integran automáticamente** en la base local.
