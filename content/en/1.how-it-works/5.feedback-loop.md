...
When a change does not pass the quality rules, it is **held back for review**.
...
If the modification is deemed valid by the user despite the flag, it is **manually accepted** and integrated into the local database.
