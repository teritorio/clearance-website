...
- [Réplication OSM](/fr/docs/how-it-works/replication) — Le mécanisme de copie locale synchronisée et contrôlée
- [Lecture sémantique](/fr/docs/how-it-works/semantic) — Comment Clearance interprète le sens des modifications
- [Boucle d'amélioration](/fr/docs/how-it-works/feedback-loop) — Le cycle de correction et d'acceptation des changements
